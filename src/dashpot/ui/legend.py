...
RELATED_ROWS_NOTE = (
    ...
    "the Dashboard peer "
    "from the focused cursor by lighting the related row's activity cell and "
    "bolding its identifying cells (HARNESS and TARGET for Sessions). Sessions "
    "links its location and Branch; "
