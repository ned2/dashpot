...
RELATED_ROWS_NOTE = (
    ...
    "the Dashboard peer "
    "from the focused cursor by lighting the related row's ◈ agent-activity "
    "cell and bolding its identifying cells (HARNESS and TARGET for Sessions, "
    "PATH for Worktrees, BRANCH for Branches). Sessions links its location and "
    "Branch; "
