...
Branches by default on a first preview, discloses the Worktree's ignored
content rather than asking for its acknowledgement, recaps what confirming
removes and deletes in a callout beneath a fixed-label button
